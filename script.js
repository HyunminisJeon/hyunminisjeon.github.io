...
class DesktopPortfolio {
    ...
    getAboutContent() {
        return `
            <div class="content-section">
                <h2>About Me</h2>
                <p>Hi, I'm Hoang Le Ngoc – a dedicated Software Engineer with a strong focus on backend development and scalable system design. With over 3+ years of experience building reliable applications, I thrive in dynamic environments and enjoy tackling real-world challenges with clean, maintainable code.</p>
                
                <h3>Background</h3>
                <p>I'm a Software Engineer specializing in Python, Node.js, and PHP development. Currently working as a Middle Software Engineer at Tenomad Company in Hue, Vietnam. I have a Computer Science degree from Hue University of Sciences and extensive experience in competitive programming.</p>
                
                <h3>What I Do</h3>
                <ul>
                    <li>Backend development with Python (Flask, FastAPI, Django)</li>
                    <li>Modern web development with Node.js and PHP Laravel</li>
                    <li>Database design and optimization (PostgreSQL, MySQL, MongoDB, Elasticsearch)</li>
                    <li>DevOps and cloud technologies (Docker, CI/CD, AWS, Azure, Google Cloud)</li>
                    <li>Computer Vision and AI applications (OpenCV, TensorFlow, PyTorch, YOLO)</li>
                    <li>Natural Language Processing with Langchain and AI SDK</li>
                </ul>
                
                <h3>Competitive Programming Excellence</h3>
                <p>I have a strong competitive programming background with notable achievements including Bronze Medal at ICPC Asia Ho Chi Minh City Regional Contest 2022, multiple prizes at Vietnam National ICPC contests, and Second Prize in Vietnam Student Olympiad in Informatics 2020.</p>
                
                <h3>Philosophy</h3>
                <p>I'm passionate about lifelong learning. Whether it's a new tool, paradigm, or language—I'm always on the lookout for better ways to build. At work, I primarily use modern frameworks and cloud-native tools to deliver high-quality solutions within an agile team.</p>
            </div>
        `;
    }
        ...
        return `
            <div class="content-section">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <p><strong>Tenomad Company</strong> | February 2025 - Present</p>
                    <p>Hue, Thua Thien Hue, Vietnam</p>
                    <ul>
                        <li>Leading backend development projects using modern frameworks</li>
                        <li>Implementing scalable solutions with cloud-native technologies</li>
                        <li>Collaborating in agile teams to deliver high-quality software</li>
                    </ul>
                </div>
                
                <div style="margin-bottom: 20px;">
                    <h4>Junior Software Engineer</h4>
                    <p><strong>Tenomad Company</strong> | September 2023 - February 2025</p>
                    <p>Hue, Thua Thien Hue, Vietnam</p>
                    <ul>
                        <li>Developed and maintained web applications using Python and Node.js</li>
                        <li>Worked with databases including PostgreSQL, MySQL, and MongoDB</li>
                        <li>Participated in code reviews and agile development processes</li>
                    </ul>
                </div>
                
                <div style="margin-bottom: 20px;">
                    <h4>Intern AI Engineer</h4>
                    <p><strong>Quy Nhon AI Research and Application Center</strong> | February 2023 - July 2023</p>
                    <p>Quy Nhon, Binh Dinh, Vietnam</p>
                    <ul>
                        <li>Developed advanced smart search engine for Vietnamese articles using Elasticsearch's cosine similarity</li>
                        <li>Researched AI, machine learning and computer vision models (OpenCV, YOLO, Tesseract, VietOCR, PaddleOCR)</li>
                        <li>Gained hands-on OCR experience with akaOCR products, achieving over 95% accuracy in object detection models</li>
                    </ul>
                </div>
                
                <div style="margin-bottom: 20px;">
                    <h4>Backend Developer</h4>
                    <p><strong>STDIO ASIA</strong> | August 2021 - November 2022</p>
                    <p>Hue, Thua Thien Hue, Vietnam</p>
                    <ul>
                        <li>Leveraged PHP Laravel framework and MySQL for company projects (Company Web Internal, PITO, Softbank)</li>
                        <li>Maintained websites, developed new platforms, and implemented client-requested functions</li>
                        <li>Explored blockchain, NFTs, smart contracts, and Rust programming language</li>
                        <li>Shared algorithm knowledge through weekly presentations using Canvas slides</li>
                    </ul>
                </div>
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <p><strong>Hue University of Sciences</strong> | August 2019 - December 2024</p>
                    <p>Comprehensive computer science education with focus on algorithms, data structures, and software engineering.</p>
                </div>
                
                <h3>Certifications</h3>
                <ul>
                    <li>AWS Certified Solutions Architect - Associate</li>
                    <li>DevOps for Freshers</li>
                    <li>EF Standard English Test Online Certificate</li>
                    <li>ICPCID</li>
                    <li>Shopee Code League 2022 - Participant</li>
                </ul>
                
                <h3>Honors & Awards</h3>
                <ul>
                    <li>Second Prize in Informatics Majors, The 2020 Vietnam Student Olympiad in Informatics (OLP'20)</li>
                    <li>Bronze Medal, The 2022 ICPC Asia Ho Chi Minh City Regional Contest (team HUSC.[401]_UnauthorizeD)</li>
                    <li>Third Prize, The 2020 ICPC Vietnam National Contest (team No Girl No AC)</li>
                    <li>Third Prize, The 2021 ICPC Vietnam National Contest (team The Phoenix Rises)</li>
                    <li>Fourth Prize, Code Tour Danang 2023</li>
                </ul>
            </div>
        `;
    }
    ...
    getProjectsContent() {
        return `
            <div class="content-section">
                <h2>My Projects</h2>
                <p>Here are some of the projects I've worked on, showcasing my expertise in backend development, AI/ML, and web technologies:</p>
                
                <div class="projects-grid">
                    <div class="project-card">
                        <h4>Vietnamese Article Smart Search Engine</h4>
                        <p>Advanced search engine for Vietnamese articles using Elasticsearch's cosine similarity. Developed during internship at Quy Nhon AI Research and Application Center.</p>
                        <div class="project-tech">
                            <span class="tech-tag">Python</span>
                            <span class="tech-tag">Elasticsearch</span>
                            <span class="tech-tag">NLP</span>
                            <span class="tech-tag">Vietnamese Language</span>
                        </div>
                    </div>
                    
                    <div class="project-card">
                        <h4>akaOCR - Object Detection System</h4>
                        <p>Contributed to OCR product development with polygon bounding box labeling and training object detection models achieving over 95% accuracy.</p>
                        <div class="project-tech">
                    ...
                    <div class="project-card">
                        ...
                        <p>Developed and maintained multiple enterprise web applications including Company Web Internal, PITO, and Softbank projects using modern frameworks.</p>
                        <div class="project-tech">
                    ...
                    <div class="project-card">
                        ...
                        <p>Built reliable backend applications using Python frameworks (Flask, FastAPI, Django) and Node.js for various client projects at Tenomad Company.</p>
                        <div class="project-tech">
                            <span class="tech-tag">Python</span>
                    ...
                    <div class="project-card">
                        <h4>Competitive Programming Solutions</h4>
                        <p>Developed algorithmic solutions for competitive programming contests including ICPC regional and national contests, achieving bronze medal and multiple prizes.</p>
                        <div class="project-tech">
                    ...
                    <div class="project-card">
                        ...
                        <p>Developed and deployed applications using cloud technologies and DevOps practices including Docker containerization and CI/CD pipelines.</p>
                        <div class="project-tech">
                    ...
                    <div class="project-card">
                        <h4>AI/ML Research Projects</h4>
                        <p>Explored machine learning and computer vision models including OCR technologies, face recognition systems, and natural language processing applications.</p>
                        <div class="project-tech">
                            <span class="tech-tag">PyTorch</span>
                            <span class="tech-tag">Computer Vision</span>
                            <span class="tech-tag">OCR</span>
                            <span class="tech-tag">FaceNet</span>
                        </div>
                    </div>
                    
                    <div class="project-card">
                        <h4>Blockchain & Smart Contracts</h4>
                        <p>Researched and explored blockchain technology, NFTs, and smart contracts while learning Rust programming language for future development strategies.</p>
                        <div class="project-tech">
    ...
    getSkillsContent() {
        return `
            <div class="content-section">
                ...
                <p>Here's an overview of my technical expertise and tools I work with:</p>
                ...
                <div class="skills-grid">
                    ...
                    <div class="skill-category">
                        ...
                        <ul>
                            ...
                            <li>Object Detection (YOLO, FaceNet)</li>
                            <li>OCR Technologies (Tesseract, VietOCR, PaddleOCR)</li>
                            <li>Natural Language Processing</li>
                            <li>Langchain & AI SDK</li>
                ...
                <div class="skills-section">
                    <h3>Languages</h3>
                    <ul>
                        <li><strong>Vietnamese:</strong> Native or Bilingual</li>
            ...
            <div class="content-section">
                ...
                <div class="contact-info">
                    ...
                    <div class="contact-item">
                        ...
                        <div class="contact-details">
                            <h4>Location</h4>
                            <p>134 Truong Chinh, Hue City, Vietnam</p>
                        </div>
                    </div>
                    ...
                    <div class="contact-item">
                        ...
                        <div class="contact-details">
                            <h4>LinkedIn</h4>
                            <p>linkedin.com/in/justinianus</p>
                        </div>
                    </div>
                </div>
    ...
    getSocialContent() {
        return `
            <div class="content-section">
                ...
                <p>Connect with me on various platforms and check out my work:</p>
                
                <div class="social-links">
                    <a href="https://github.com/Justinianus2001" class="social-link" target="_blank">
                        <div class="social-icon github">💻</div>
                        <div class="social-details">
                            <h4>GitHub</h4>
                            <p>github.com/Justinianus2001</p>
                            <small>Check out my code repositories and projects</small>
                        </div>
                    </a>
                    
                    <a href="https://www.linkedin.com/in/justinianus" class="social-link" target="_blank">
                        <div class="social-icon linkedin">💼</div>
                        <div class="social-details">
                            <h4>LinkedIn</h4>
                            <p>linkedin.com/in/justinianus</p>
                            <small>Professional network and career updates</small>
                        </div>
                    </a>
                    
                    <a href="https://www.kaggle.com/justinianus" class="social-link" target="_blank">
                        <div class="social-icon kaggle">�</div>
                        <div class="social-details">
                            <h4>Kaggle</h4>
                            <p>kaggle.com/justinianus</p>
                            <small>Data science competitions and datasets</small>
                        </div>
                    </a>
                    
                    <a href="mailto:lengochoang681@gmail.com" class="social-link" target="_blank">
                        <div class="social-icon email">📧</div>
                        <div class="social-details">
                            <h4>Email</h4>
                            <p>lengochoang681@gmail.com</p>
                            <small>Direct contact for opportunities</small>
                        </div>
                    </a>
                </div>
                
                <h3>Online Presence</h3>
                <p>You can find me across various platforms where I share my work, participate in programming competitions, and connect with the developer community. I'm particularly active on GitHub where I maintain my projects and contribute to open-source initiatives.</p>
                
                <h3>Portfolio & Work</h3>
                <p>My GitHub profile showcases various projects ranging from AI/ML applications to web development. My Kaggle profile demonstrates my interest in data science and machine learning competitions. Feel free to explore, provide feedback, or reach out for collaborations!</p>
            </div>
        `;
    }
